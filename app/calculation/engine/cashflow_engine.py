...
class CashflowEngine(BaseEngine):
    ...
    def calculate(
        self, start_date: date, months: int, income: float, expense: float = 0.0
    ) -> List[Dict[str, Any]]:
        """
        ...
        self.validate_inputs(
            start_date=start_date, months=months, income=income, expense=expense
        )
    ...
    def validate_inputs(
        self, start_date: date, months: int, income: float, expense: float
    ) -> bool:
        """
