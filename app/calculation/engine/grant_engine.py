...
class GrantEngine(BaseEngine):
    ...
    @staticmethod
    def _calc_grant_components(
        gross: float, params: TaxParameters
    ...
    def calculate(
        ...
        self.validate_inputs(
            base_amount=base_amount, start_date=start_date, end_date=end_date
        )
    ...
    def validate_inputs(
        self, base_amount: float, start_date: date, end_date: date
    ) -> bool:
        """
