...
class PensionEngine(BaseEngine):
    ...
    @staticmethod
    def _calc_monthly_pension_from_capital(
        capital: float, params: TaxParameters
    ) -> float:
    ...
    def _project_pension_cashflow(
        ...
        for i in range(months):
            ...
            if fund.indexation_method == "none":
                ...
                fund.indexation_method == "fixed" and fund.fixed_index_rate is not None
            ):
                ...
                fund.indexation_method == "cpi"
                and params
                and hasattr(params, "cpi_series")
            ):
    ...
    def calculate(self, capital: float, params: Dict[str, Any] = None) -> float:
        """
    ...
    def calculate_with_details(
        self, capital: float, params: Dict[str, Any] = None
    ) -> Dict[str, float]:
        """
