...
class Grant(Base):
    ...
    grant_indexed_amount = Column(
        Float, nullable=True
    )  # ׳¡׳›׳•׳ ׳׳•׳¦׳׳“ ("׳׳¢׳ ׳§ ׳₪׳˜׳•׳¨ ׳¦׳׳•׳“")
    limited_indexed_amount = Column(
        Float, nullable=True
    )  # ׳¡׳›׳•׳ ׳׳•׳’׳‘׳ ׳-32 ׳©׳ ׳™׳ ("׳׳¢׳ ׳§ ׳₪׳˜׳•׳¨ ׳¦׳׳•׳“ (32 ׳©׳ ׳™׳)")
    ...
    def to_dict(self):
        return {
            ...
            "work_start_date": (
                self.work_start_date.isoformat() if self.work_start_date else None
            ),
            "work_end_date": (
                self.work_end_date.isoformat() if self.work_end_date else None
            ),
