...
from app.schemas.scenario import ScenarioIn, ScenarioOut, ScenarioCreateIn, ScenarioListOut, ScenarioListItem, ScenarioCreateResponse
...
@router.post("/clients/{client_id}/scenarios", status_code=status.HTTP_201_CREATED, response_model=ScenarioCreateResponse)
