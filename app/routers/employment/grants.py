...
def add_grant_to_current_employer(
    client_id: int, grant_data: EmployerGrantCreate, db: Session = Depends(get_db)
):
    """
    ...
    try:
        ...
        return GrantWithCalculation(**grant.to_dict(), calculation=calculation)
        ...
        status_code = (
            ...
            if ("לא נמצא" in message or message in not_found_messages)
