...
class PaymentCalculator(BaseCalculator):
    ...
    def calculate(
        ...
        self.validate_inputs(
            start_date=start_date, end_date=end_date, frequency=frequency, amount=amount
        )
    ...
    def _generate_monthly_payments(
        self, start_date: date, end_date: date, amount: Decimal
    ) -> List[Tuple[date, Decimal]]:
        """
        צור תשלומים חודשיים.
    ...
    def is_payment_date(
        self, current_date: date, start_date: date, frequency: PaymentFrequency
    ) -> bool:
        """
