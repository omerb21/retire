...
class GrantService:
    ...
    def add_grant(
        self, employer: CurrentEmployer, grant_data: EmployerGrantCreate
        ...
        # יצירת מענק
        grant = EmployerGrant(employer_id=employer.id, **grant_data.model_dump())
    ...
    def delete_grants_by_employer(
        self, employer: CurrentEmployer, grant_type: str = None
    ) -> int:
        """
