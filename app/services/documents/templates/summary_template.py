...
class SummaryHTMLTemplate:
    ...
    def _calculate_values(self) -> Dict[str, float]:
        ...
        remaining_exempt_capital = self.exemption_summary.get(
        ...
        idf_security_forces_impact = self.exemption_summary.get(
            "idf_security_forces_impact", 0
        )
        pension_ceiling = 9430
        exemption_percentage = (
            (exempt_pension / pension_ceiling * 100) if pension_ceiling > 0 else 0
        )
