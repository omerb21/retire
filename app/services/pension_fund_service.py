...
def _compute_indexation_factor(
    method: str | None,
    start: date | None,
...
def compute_and_apply_indexation(
    fund: PensionFund, reference_date: Optional[date] = None
) -> Tuple[float, float]:
...
def compute_and_persist(
    db: Session, fund: PensionFund, reference_date: Optional[date] = None
) -> PensionFund:
    """Compute pension amounts and persist to database"""
