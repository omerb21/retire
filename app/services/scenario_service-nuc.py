...
from app.schemas.scenario import ScenarioCreateIn, ScenarioOut, CashflowPoint, ScenarioListItem, ScenarioCreateResponse
...
class ScenarioService:
    @staticmethod
    def create_scenario(db: Session, client_id: int, data: ScenarioCreateIn) -> ScenarioCreateResponse:
