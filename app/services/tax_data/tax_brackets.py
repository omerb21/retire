            ...
            return [
                {
                    ...
                    "max_income": 81480,
                    "rate": 0.10,
                    "description": "מדרגה ראשונה - 10%",
                },
                {
                    "min_income": 81481,
                    "max_income": 116760,
                    "rate": 0.14,
                    "description": "מדרגה שנייה - 14%",
                },
                {
                    "min_income": 116761,
                    "max_income": 187440,
                    "rate": 0.20,
                    "description": "מדרגה שלישית - 20%",
                },
                {
                    "min_income": 187441,
                    "max_income": 241680,
                    "rate": 0.31,
                    "description": "מדרגה רביעית - 31%",
                },
                {
                    "min_income": 241681,
                    "max_income": 498360,
                    "rate": 0.35,
                    "description": "מדרגה חמישית - 35%",
                },
                {
                    "min_income": 498361,
                    "max_income": 663240,
                    "rate": 0.47,
                    "description": "מדרגה שישית - 47%",
                },
                {
                    "min_income": 663241,
                    "max_income": 999999999,
                    "rate": 0.50,
                    "description": "מדרגה עליונה - 50%",
                },
            ]
        elif year >= 2023:
            # 2023 tax brackets
