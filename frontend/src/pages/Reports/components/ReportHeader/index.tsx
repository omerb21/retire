      ...
      {fixationData && fixationData.exemption_summary && (
        <div className="report-header-fixation">
          ...
          <div className="report-header-grid">
            ...
            <div>
              <strong>קצבה פטורה מקיבוע ({fixationData.eligibility_year || fixationData.exemption_summary.eligibility_year || '-'}):</strong>{' '}
              {typeof fixationData.exemption_summary.remaining_monthly_exemption === 'number'
                ? formatCurrency(fixationData.exemption_summary.remaining_monthly_exemption)
                : '-'}
            </div>
            <div>
