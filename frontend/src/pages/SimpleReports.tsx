...
import { ASSET_TYPES_MAP, PENSION_PRODUCT_TYPES, generateCashflowOperationsDetails, generatePieChartData } from '../components/reports/utils/reportUtils';
import { calculateNPVComparison } from '../components/reports/calculations/npvCalculations';
import { drawPieChart } from '../components/reports/utils/chartUtils';
...
<body>
    ...
    <div class="section">
            ...
            <tbody>
                ${pensionFunds.map(fund => `
                    <tr>
                        ...
                        <td>${(fund.annuity_factor || 0).toFixed(2)}</td>
        ...
        <div style="margin-top: 10px; font-weight: bold;">
            סה"כ מקדם קצבה: ${pensionFunds.reduce((sum, f) => sum + (parseFloat(f.annuity_factor) || 0), 0).toFixed(2)} | 
