  ...
  return (
    <div>
      <div className="modern-card">
        ...
        {/* Other tabs remain in original file for now - will be refactored in next phase */}
        {(activeTab === 'fixation' || activeTab === 'scenarios' || activeTab === 'termination' || activeTab === 'annuity') && (
          <div style={{ padding: '20px', textAlign: 'center', color: '#666' }}>
            <p>תוכן הטאב "{activeTab}" נמצא בקובץ המקורי</p>
            <p>ניתן להמשיך ולפצל גם אותו בשלב הבא</p>
          </div>
        )}
      </div>
    </div>
