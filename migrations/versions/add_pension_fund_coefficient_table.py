...
def upgrade():
    ...
    op.create_index(
        op.f("ix_pension_fund_coefficient_sex"),
        "pension_fund_coefficient",
        ["sex"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pension_fund_coefficient_retirement_age"),
        "pension_fund_coefficient",
        ["retirement_age"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pension_fund_coefficient_survivors_option"),
        "pension_fund_coefficient",
        ["survivors_option"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_pension_fund_coefficient_survivors_option"),
        table_name="pension_fund_coefficient",
    )
    op.drop_index(
        op.f("ix_pension_fund_coefficient_retirement_age"),
        table_name="pension_fund_coefficient",
    ...
    op.drop_index(
        op.f("ix_pension_fund_coefficient_sex"), table_name="pension_fund_coefficient"
    )
