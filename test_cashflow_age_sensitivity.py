...
try:
    ...
    if result_70.get("success"):
        ...
        print(f"  Projected Pension: ₪{result_data_70.get('projected_pension', 0):,.2f}/month")
        print(f"  Total Guaranteed Income: ₪{result_data_70.get('total_guaranteed_income', 0):,.2f}/month")
    else:
    ...
    if result_71.get("success"):
        ...
        print(f"  Projected Pension: ₪{result_data_71.get('projected_pension', 0):,.2f}/month")
        print(f"  Total Guaranteed Income: ₪{result_data_71.get('total_guaranteed_income', 0):,.2f}/month")
    else:
    ...
    if result_70.get("success") and result_71.get("success"):
        ...
        if pension_70 == pension_71:
            ...
            pct_increase = ((pension_71 - pension_70) / pension_70 * 100) if pension_70 > 0 else 0
    ...
    print("4. If factors are identical or source is 'default', there's a data/logic issue")
    print("\n" + "=" * 100)
