...
def test_stageG_trace_payload_is_mcpdecision_only(monkeypatch) -> None:
    ...
    from app.services.llm_chat.mcp.types import MCPDecision
    ...
    assert payload.get("trace_summary_version") == "stageG_v1"
    ...
    expected_keys = set(MCPDecision.__dataclass_fields__.keys())
