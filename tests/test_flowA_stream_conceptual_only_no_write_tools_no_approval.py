...
def test_flowA_stream_conceptual_only_no_write_tools_no_approval(monkeypatch) -> None:
    ...
    resp = api.post(
        ...
        json={
            ...
            "messages": [
                {
                    "role": "user",
                    "content": "מה אפשר לעשות עם הפיצויים מעסיק נוכחי? אני מבקש להסביר עקרון בלבד, בלי לבצע.",
                }
            ],
            "pension_portfolio": [],
        },
