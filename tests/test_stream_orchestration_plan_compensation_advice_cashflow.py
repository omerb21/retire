...
def test_stream_orchestration_plan_compensation_advice_runs_cashflow_tool_and_appends_summary(
    monkeypatch,
) -> None:
    def fake_chat_stream(messages, client_id=None):
        raise AssertionError(
            "LLM must not be called for compensation advice orchestration"
        )
