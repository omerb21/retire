...
def test_stream_pending_plan_target_continue_triggers_build_target_plan(monkeypatch, _test_db) -> None:
    ...
    def fake_chat_stream(messages, client_id=None):
        raise AssertionError("LLM must not be called when pending_plan_target numeric continue triggers tools-first")
