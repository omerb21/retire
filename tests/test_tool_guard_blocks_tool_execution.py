...
def test_tool_guard_blocks_tool_execution_emits_validation_error(monkeypatch, _test_db) -> None:
    ...
    def _boom(*args, **kwargs):
        raise AssertionError("Underlying execute_tool_call must NOT be called when guard blocks")
    ...
    decision = PolicyDecision(mode=ExecutionMode.LLM_TOOL_ROUTED, tools_allowed=False, write_allowed=False)
