...
def render_cashflow_chart(
    cashflow: List[Dict[str, Any]], title: str = "Cashflow Projection"
) -> io.BytesIO:
    """
...
def render_income_breakdown_chart(
    cashflow: List[Dict[str, Any]], title: str = "Income Breakdown"
) -> io.BytesIO:
    """
...
def render_cumulative_chart(
    cashflow: List[Dict[str, Any]], title: str = "Cumulative Income"
) -> io.BytesIO:
    """
    ...
    # Plot area chart
    ax.fill_between(
        years, cumulative_net, alpha=0.6, color="#2E86AB", label="Cumulative Net Income"
    )
...
def render_tax_analysis_chart(
    cashflow: List[Dict[str, Any]], title: str = "Tax Analysis"
) -> io.BytesIO:
    """
    ...
    ax2.plot(
        years, tax_rates, color=color2, marker="o", linewidth=2, label="Tax Rate %"
    )
...
def create_summary_pie_chart(
    summary_data: Dict[str, float], title: str = "Income Summary"
) -> io.BytesIO:
    """
